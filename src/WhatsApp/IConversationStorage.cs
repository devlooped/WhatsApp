...
public interface IConversationStorage
{
    ...
    /// provided user and message IDs are valid and correspond  to an existing message. The operation can be canceled by
    /// passing a cancellation token.</remarks>
    /// <param name="userId">The user identifier associated with the message. Cannot be null or empty.</param>
    /// <param name="messageId">The unique identifier of the message to retrieve. Cannot be null or empty.</param>
    ...
    Task<IMessage?> GetMessageAsync(string userId, string messageId, CancellationToken cancellationToken = default);
    ...
    /// <param name="userId">The phone number for which to retrieve messages. This must be a valid phone number in the expected format.</param>
    ...
    IAsyncEnumerable<IMessage> GetMessagesAsync(string userId, CancellationToken cancellationToken = default);
    ...
    /// <param name="userId">The user associated with the conversation. This parameter cannot be null or empty.</param>
    ...
    IAsyncEnumerable<IMessage> GetMessagesAsync(string userId, string conversationId, CancellationToken cancellationToken = default);
    ...
    /// <param name="userId">The user for which to retrieve the active conversation ID.  This parameter cannot be null or empty.</param>
    ...
    Task<Conversation?> GetActiveConversationAsync(string userId, CancellationToken cancellationToken = default);
}